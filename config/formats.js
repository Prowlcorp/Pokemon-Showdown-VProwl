...
let Formats = [
	...
	},
	{
		...
		banlist: [
			'Illegal', 'Arceus', 'Darkrai', 'Deoxys-Base', 'Deoxys-Attack', 'Deoxys-Defense', 'Dialga', 'Giratina',
	...
	},
	{
		...
		validateSet(set, teamHas) {
			...
			if (!template.exists || template === crossTemplate) return this.validateSet(set, teamHas);
