	...
	getDetails = () => {
		...
		if (this.illusion) {
			const illusionDetails = this.illusion.species.name + (this.level === 100 ? '' : ', L' + this.level) +
				(this.illusion.gender === '' ? '' : ', ' + this.illusion.gender) + (this.illusion.set.shiny === "Albino" ? ', albino' : this.illusion.set.shiny === "Shiny" ? ', shiny' : '') + (this.illusion.set.card === "Albino" ? ', albino' : this.illusion.set.card === "Shiny" ? ', shiny' : this.illusion.set.card === "Normal" ? ', normal' : '');
