...
let BattleItems = {
	...
	"giracariocrystal": {
		id: "giracariocrystal",
		name: "Giracario Crystal",
		spritenum: 594,
		megaStone: "Giracario-Alt",
	...
	"leek": {
		...
		onModifyCritRatio(critRatio, user) {
			if (user.baseTemplate.species === 'Farfetch\'d' || user.baseTemplate.species === 'Mallar\'kee') {
				return critRatio + 2;
			}
		},
	...
	"meowsticitef": {
		...
		desc: "If held by a Meowstic-F, this item allows it to Mega Evolve in battle.",
	},
	"metagrossite": {
		id: "metagrossite",
		name: "Metagrossite",
